...
describe("cipher/prf", () => {
  ...
  test("prfVerifyDataClient", () => {
    ...
    const serverKeyExchange = Buffer.from([
      0x0c,
      0x00,
      0x01,
      0x28,
    ...
    const serverHelloDone = Buffer.from([0x0e, 0x00, 0x00, 0x00]);
    const clientKeyExchange = Buffer.from([
      0x10,
      0x00,
      0x00,
      0x21,
    ...
    const expectedVerifyData = Buffer.from([
      0xcf,
      0x91,
      0x96,
      0x26,
    ...
    const verifyData = prfVerifyDataClient(masterSecret, final);
    expect(expectedVerifyData).toEqual(verifyData);
  });
});
